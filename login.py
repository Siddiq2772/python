...
login_b1 = RoundedButton(login_frame,width=100, height=30, corner_radius=10, 
                           padding=4, color='lightblue', hover_color='skyblue',  text="Login",  command=handle_login_click)
...
signup_b1 = RoundedButton(signup_frame,width=100, height=30, corner_radius=10, 
                           padding=4,color='lightblue', hover_color='skyblue',  text="Sign Up", command=handle_signup_click)
